export function TruckMark({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden="true" fill="none">
      <rect x="4" y="16" width="34" height="28" rx="5" fill="#FF7A00" />
      <path
      ...
      <rect x="4" y="40" width="55" height="4" rx="2" fill="#0C0C0C" opacity=".35" />
      ...
      <path d="M11 24h20M11 30h14" stroke="#fff" strokeWidth="3" strokeLinecap="round" opacity=".9" />
    </svg>
  );
}
